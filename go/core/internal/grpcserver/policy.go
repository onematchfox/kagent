...
func DefaultMethodPolicies() MethodPolicies {
	policies := MethodPolicies{
		...
		apiv1alpha1.FeedbackService_CreateFeedback_FullMethodName:             auth.AccessCreate,
		apiv1alpha1.FeedbackService_ListFeedback_FullMethodName:               auth.AccessRead,
		...
		apiv1alpha1.AgentService_GetSandboxAgent_FullMethodName:               auth.AccessRead,
		apiv1alpha1.AgentService_CreateSandboxAgent_FullMethodName:            auth.AccessCreate,
		apiv1alpha1.AgentService_UpdateSandboxAgent_FullMethodName:            auth.AccessUpdate,
		apiv1alpha1.AgentService_DeleteSandboxAgent_FullMethodName:            auth.AccessDelete,
		apiv1alpha1.AgentService_GetAgentHarness_FullMethodName:               auth.AccessRead,
		apiv1alpha1.AgentService_CreateAgentHarness_FullMethodName:            auth.AccessCreate,
		apiv1alpha1.AgentService_DeleteAgentHarness_FullMethodName:            auth.AccessDelete,
