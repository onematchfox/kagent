        ...
        try {
          ...
          const fetchedParams: Record<string, unknown> =
            (spec.openAI ?? spec.anthropic ?? spec.azureOpenAI ?? spec.ollama ??
             spec.gemini ?? spec.geminiVertexAI ?? spec.anthropicVertexAI ?? spec.bedrock ?? spec.sapAICore ?? spec.foundry ?? {}) as Record<string, unknown>;
  ...
  const handleSubmit = async () => {
    ...
    switch (providerType) {
      ...
      case 'SAPAICore':
        ...
        break;
      case 'Foundry':
        spec.foundry = providerParams as FoundryConfig;
        break;
      default:
